function [powerMat] = scheme3_SCP(timeRatio, powerMatInit,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT)
...
for ii = 1:N
  cons =  timeRatio*(-log(1 + powerMat(3,2*ii-1)*gammaRRT(ii))...
      - log(1 + powerMat(3,2*ii-1)*gammaRDT(ii) + powerMat(1,2*ii-1)*gammaSDT(ii))...
      ...
      - log(1 + powerMat(3,2*ii)*gammaRDT(ii) + powerMat(1,2*ii)*gammaSDT(ii))...
...
for ii = 1:N
  obj = timeRatio*(log(1 + powerMatInit(3,2*ii-1)*gammaRRT(ii))...
      + log(1 + powerMatInit(1,2*ii-1)*gammaSDT(ii) + powerMatInit(3,2*ii-1)*gammaRDT(ii))...
      - log(1 + powerMat(3,2*ii-1)*gammaRRT(ii) + powerMat(1,2*ii-1)*gammaSRT(ii))...
      - log(1 + powerMat(1,2*ii-1)*gammaSDT(ii) + powerMat(2,2*ii-1)*gammaSDT(ii) + powerMat(3,2*ii-1)*gammaRDT(ii))...
      + gammaRRT(ii)/(1 + powerMatInit(3,2*ii-1)*gammaRRT(ii))*(powerMat(3,2*ii-1) - powerMatInit(3,2*ii-1))...
      + gammaSDT(ii)/(1 + powerMatInit(1,2*ii-1)*gammaSDT(ii) + powerMatInit(3,2*ii-1)*gammaRDT(ii))*(powerMat(1,2*ii-1) - powerMatInit(1,2*ii-1))...
      + gammaRDT(ii)/(1 + powerMatInit(1,2*ii-1)*gammaSDT(ii) + powerMatInit(3,2*ii-1)*gammaRDT(ii))*(powerMat(3,2*ii-1) - powerMatInit(3,2*ii-1)))...
      + (1-timeRatio)*(log(1 + powerMatInit(3,2*ii)*gammaRRT(ii))...
      + log(1 + powerMatInit(1,2*ii)*gammaSDT(ii) + powerMatInit(3,2*ii)*gammaRDT(ii))...
      - log(1 + powerMat(3,2*ii)*gammaRRT(ii) + powerMat(1,2*ii)*gammaSRT(ii))...
      - log(1 + powerMat(1,2*ii)*gammaSDT(ii) + powerMat(2,2*ii)*gammaSDT(ii) + powerMat(3,2*ii)*gammaRDT(ii))...
      + gammaRRT(ii)/(1 + powerMatInit(3,2*ii)*gammaRRT(ii))*(powerMat(3,2*ii) - powerMatInit(3,2*ii))...
      + gammaSDT(ii)/(1 + powerMatInit(1,2*ii)*gammaSDT(ii) + powerMatInit(3,2*ii)*gammaRDT(ii))*(powerMat(1,2*ii) - powerMatInit(1,2*ii))...
      + gammaRDT(ii)/(1 + powerMatInit(1,2*ii)*gammaSDT(ii) + powerMatInit(3,2*ii)*gammaRDT(ii))*(powerMat(3,2*ii) - powerMatInit(3,2*ii)))...
      + obj;
end
Objective = obj;
