...
%         feasId(kk,1) = scheme3_SCP_CheckFeasibility(timeRatioInit,powerMatInit2,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT(:,kk));
%         feasId(kk,2) = scheme3_SCP_CheckFeasibility(timeRatioInit,powerMatInit3,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT(:,kk));
%         feasId(kk,3) = scheme3_SCP_CheckFeasibility(timeRatioInit,powerMatInit4,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT(:,kk));
%     end
%     
...
%     end
    ...
    for kk = 1%:length(Rho)
        ...
        powerMatInit2 = powerMatInitTwo(P_S,P_R,N,gammaSRT,gammaRDT,gammaRRT,gammaSDT);
        
        % initial point 2 
        [rate2,timeRatio2,powerMat2,iter2] = alterOptim3(timeRatioInit, powerMatInit2,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT);
        
        % initial point 3
        [rate3,timeRatio3,powerMat3,iter3] = alterOptim3(timeRatioInit, powerMatInit3,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT);
        
        % initial point 4
        [rate4,timeRatio4,powerMat4,iter4] = alterOptim3(timeRatioInit, powerMatInit4,P_S,P_R,N,gammaSRT,gammaRDT,gammaSDT,gammaRRT(:,kk));
